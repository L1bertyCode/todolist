...
export const tasksApi = {
  ...
  createTask(payload: { todolistId: string; title: string }) {
    ...
    return instance.post<BaseTaskResponse<DomainTask>>(`todo-lists/${todolistId}/tasks`, { title })
  },
  removeTask(payload: { taskId: string; todolistId: string }) {
    const { taskId, todolistId } = payload
    return instance.delete<BaseTaskResponse>(`todo-lists/${todolistId}/tasks/${taskId}`)
  },
